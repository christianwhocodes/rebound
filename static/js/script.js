...
function initAudio(){
    //load audio files
    beepX = new Audio('static/sounds/beepX.mp3');
    beepY = new Audio('static/sounds/beepY.mp3');
    beepPaddle = new Audio('static/sounds/beepPaddle.mp3');
    beepGameOver = new Audio('static/sounds/beepGameOver.mp3');
    bgMusic = new Audio('static/sounds/music.mp3');
    //turn off volume
    beepX.volume = 0;
    beepY.volume = 0;
    beepPaddle.volume = 0;
